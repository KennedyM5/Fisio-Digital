...
<div class="form-group row" >
    ...
    <button type="submit" class="btn btn-primary align-self-center m-2" value="Login" name="search">Procurar Clinicas</button>
  </div>
</form>
    <hr>
    ...
    <?php
        if(isset($_GET['search']) && !empty($_GET['location']))
        {
            ...
            {   
                ...
                echo "</table>  <br> <br>";
                echo " <button type='submit' class='btn btn-primary ml-auto mb-50' value='selectclinic' name='selectclinic'>Selecionar clinica</button>";
                echo "</form> </div>";
                }
                else {
